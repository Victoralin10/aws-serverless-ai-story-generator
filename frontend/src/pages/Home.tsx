...
import SceneSuggestionForm from '../components/SceneSuggestionForm';

const Home: React.FC = () => {

  const [showSceneSuggestionForm, setShowSceneSuggestionForm] = useState(false);

  const handleEmpezarClick = () => {
    setShowSceneSuggestionForm(!showSceneSuggestionForm);
  };
  return <div className="relative isolate overflow-hidden bg-gray-900 min-h-screen">
    <img
        ...
        <div className="mx-auto max-w-4xl flex items-center align-middle h-screen -mt-20">
          <div className="text-center pt-20 items-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-pink-500">Experimenta la Magia de las Historias Generadas por Inteligencia Artificial para tus Niños</span>
            </h1>
            <h2 className="text-xl font-bold tracking-tight text-gray-300 sm:text-xl py-6 max-w-xl mx-auto">
              Aplicación de código abierto impulsada por eventos que genera una nueva historia para dormir para tus hijos todas las noches.
            </h2>
            <button
              type="button"
            ...
            {showSceneSuggestionForm && <SceneSuggestionForm />}
            <SubscribeForm />
          </div>
        </div>
